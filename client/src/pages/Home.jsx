...
import evalImg from '../assets/ai-ans.png'
 ...
 import analyticsImage from '../assets/history.png'
...
<div className='flex justify-center mb-6'>
  ...
  <div className='bg-gray-200 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
     ...
     <div className='text-center mb-28'>
      ...
      className='text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto'>
        ...
        <span className='relative inline-block'>
          <span className='bg-green-50 text-green-600 px-5 py-1 rounded-full'>
            AI Intelligence
          </span>
        </span>
      </motion.h1>
      ...
      <div className='flex flex-wrap justify-center gap-4 mt-10'>
         ...
         ileHover={{opacity:0.7,scale:1.05}}
...
className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md'
        ...
        Start Interview
         ...
         ileHover={{opacity:0.7,scale:1.05}}
whileTap={{opacity:1,scale:0.98}}
className='border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-300 transition'
         >
        View History
         </motion.button>
      </div>
        ...
        [
          {
            ...
            desc:"AI adjusts difficulty based on selected jon role."
          },
          {
            icon:<BsMic size={24}/>,
            step:"STEP 2",
    ...
    <div className='grid md:grid-cols-2 gap-10'>
      {
        [
          ...
          },
          {
            ...
            desc : "Basic tone and vioce analysis insights."
          },
          {
            image:creditImage,
